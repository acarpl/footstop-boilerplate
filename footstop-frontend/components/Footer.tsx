      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-10">
        ...
        <div className="space-y-3 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start space-y-2">
            <Image src="/icons/Footstop.png" alt="FootStop Logo" width={70} height={70} />
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-1">
            <li><Link href="/info/about" className="hover:text-gray-800">About</Link></li>
          </ul>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-1">
            <li><Link href="/info/support" className="hover:text-gray-800">Customer Support</Link></li>
            <li><Link href="/info/delivery" className="hover:text-gray-800">Delivery Details</Link></li>
            <li><Link href="/info/terms" className="hover:text-gray-800">Terms & Conditions</Link></li>
            <li><Link href="/info/privacy-policy" className="hover:text-gray-800">Privacy Policy</Link></li>
          </ul>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-1">
            <li><Link href="/info/account" className="hover:text-gray-800">Account</Link></li>
            <li><Link href="/info/manage-deliveries" className="hover:text-gray-800">Manage Deliveries</Link></li>
            <li><Link href="/info/orders" className="hover:text-gray-800">Orders</Link></li>
            <li><Link href="/info/payment" className="hover:text-gray-800">Payment</Link></li>
          </ul>
        </div>
